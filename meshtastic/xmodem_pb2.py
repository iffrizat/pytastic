...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_XMODEM']._serialized_end=251
  _globals['_XMODEM_CONTROL']._serialized_start=168
  _globals['_XMODEM_CONTROL']._serialized_end=251
